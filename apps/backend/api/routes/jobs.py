...
async def draft_job_post_route(
    body: JobPostDraftRequest, settings: SettingsDep, _user_id: UserIdDep
) -> JobPostDraftResult:
...
async def synthesize_company_intel_route(
    body: CompanyIntelRequest, settings: SettingsDep, _user_id: UserIdDep
) -> CompanyIntelResult:
...
async def generate_outreach_draft_route(
    body: OutreachDraftRequest, settings: SettingsDep, _user_id: UserIdDep
) -> OutreachDraftResult:
